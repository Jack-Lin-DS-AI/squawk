...
- **Custom rule support** via YAML with condition fields for event type, tool regex, file patterns, count thresholds, time windows, hash modes (content/edit/command), and diff patterns
